...
const UpdateUserModal = ({ isOpenModel, setIsOpenModel, userData, dataChanged }: any) => {
  ...
  dark:[&::-webkit-scrollbar-thumb]:bg-[#C1C1C1] relative h-full max-h-[calc(100vh-50px)] overflow-y-auto w-full max-w-[700px] m-4 rounded-3xl bg-white dark:bg-gray-900">
                {/* Close Button */}
                <button
                    onClick={handleClose}
