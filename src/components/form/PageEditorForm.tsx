...
const handleFile = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  dark:[&::-webkit-scrollbar-thumb]:bg-[#C1C1C1] flxed top-5 max-h-[calc(100vh-50px)] overflow-y-auto  relative w-full max-w-[calc(100vw-3rem)] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
