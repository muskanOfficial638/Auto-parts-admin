...
const ViewUserAddress = ({ isOpenModel, setIsOpenModel, userData }: any) => {
                                    ...
                                    <div>
                                        ...
                                        <div className="grid gap-4">
                                            {addresses.data?.map((address, index) => (
                                                <div key={index} className="relative p-5 bg-white border border-gray-200 rounded-xl hover:border-blue-300 transition-colors">
                                                    ...
                                                    <div className="space-y-3">
                                                        ...
                                                        <div>
                                                            <p className="font-medium text-gray-900">{address.line1}, {address.line2 ?? ''}, {address.city}, {address.province}, {address.country} ({address.postal_code})</p>
